/**
 ...
 닫는 div는 할 필요가 없음
							<div class="chat-message-right pb-4">
								<div>
									<img src="https://bootdey.com/img/Content/avatar/avatar1.png" class="rounded-circle mr-1" alt="받는사람이름" width="40" height="40">
									<div class="text-muted small text-nowrap mt-2">전송시간</div>
								</div>
								<div class="flex-shrink-1 bg-light rounded py-2 px-3 mr-3">
									<div class="font-weight-bold mb-1">받는사람이름</div>
									<spen>전송한 내용</spen>
								</div>
							</div>
...
class MessageRightCard {
	constructor(time, content) {
		...
		this.div.className = "chat-message-right pb-4";
