          ...
          <div class="content-wrapper pb-0">
            ...
            <div class="row">
              <div class="col-sm-4 stretch-card grid-margin">
                <div class="card">
                  <div class="card-body p-0">
                    <img class="img-fluid w-100" src="/resources/teacher/assets/images/dashboard/img_1.jpg" alt="" />
                  </div>
              ...
              <div class="col-sm-4 stretch-card grid-margin">
                <div class="card">
                  <div class="card-body p-0">
                    <img class="img-fluid w-100" src="/resources/teacher/assets/images/dashboard/img_2.jpg" alt="" />
                  </div>
                  <div class="card-body px-3 text-dark">
                    <div class="d-flex justify-content-between">
                      <p class="text-muted font-13 mb-0">ENTIRE APARTMENT</p>
              ...
              <div class="col-sm-4 stretch-card grid-margin">
                <div class="card">
                  <div class="card-body p-0">
                    <img class="img-fluid w-100" src="/resources/teacher/assets/images/dashboard/img_3.jpg" alt="" />
                  </div>
                  <div class="card-body px-3 text-dark">
                    <div class="d-flex justify-content-between">
                      <p class="text-muted font-13 mb-0">ENTIRE APARTMENT</p>
                    ...
                    <div class="table-responsive">
                      <table class="table custom-table text-dark">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img src="/resources/teacher/assets/images/faces/face2.jpg" class="mr-2" alt="image" /> Jacob Jensen </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="/resources/teacher/assets/images/faces/face3.jpg" class="mr-2" alt="image" /> Cecelia Bradley </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="/resources/teacher/assets/images/faces/face4.jpg" class="mr-2" alt="image" /> Leah Sherman </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="/resources/teacher/assets/images/faces/face5.jpg" class="mr-2" alt="image" /> Ina Curry </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="/resources/teacher/assets/images/faces/face7.jpg" class="mr-2" alt="image" /> Lida Fitzgerald </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="/resources/teacher/assets/images/faces/face2.jpg" class="mr-2" alt="image" /> Stella Johnson </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="/resources/teacher/assets/images/faces/face9.jpg" class="mr-2" alt="image" /> Maria Ortiz </td>
                            <td>
                              <div class="d-flex">
                                <span class="pr-2 d-flex align-items-center">65%</span>
            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-xl-4 stretch-card grid-margin">
                <div class="card color-card-wrapper">
                  <div class="card-body">
                    <img class="img-fluid card-top-img w-100" src="/resources/teacher/assets/images/dashboard/img_5.jpg" alt="" />
