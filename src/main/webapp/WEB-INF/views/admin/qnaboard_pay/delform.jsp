					...
					<div class="container" role="main">
						...
						<form id="form1">
							<div class="mb-3">
								...
								<input type="hidden" name="qnaboardpay_idx"
									value="<%=qnaboardpay.getQnaboardpay_idx()%>"> <label>제목</label>
								<input type="text" class="form-control" name="qnaboardpay_title"
									value="<%=qnaboardpay.getQnaboardpay_title()%>">
							...
							<div class="mb-3">
								...
								<label>내용</label>
								<textarea class="form-control" rows="5" name="qnaboardpay_content"><%=qnaboardpay.getQnaboardpay_content()%></textarea>
							</div>
